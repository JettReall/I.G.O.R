    ...
    <div className={classe} id={aba_botao} onClick={handleClick}>
      {aba_botao !== "adicionar" && (
        <div className={estilos['container-botoes']}>
          <button className={clsx(estilos['botao-altera-campanha'], estilos.editar)} title="Editar" />
          <button className={clsx(estilos['botao-altera-campanha'], estilos.apagar)} title="Apagar" />
        </div>
      )}
